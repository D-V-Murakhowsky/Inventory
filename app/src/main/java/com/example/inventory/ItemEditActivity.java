...
public class ItemEditActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    SpinnerArrayAdapter mCursorAdapter;
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mItemImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Dialog d = new Dialog(ItemEditActivity.this);
        ...
        Spinner spinner = findViewById(R.id.shelf_chooser);
        mCursorAdapter = new SpinnerArrayAdapter(this,  0);
